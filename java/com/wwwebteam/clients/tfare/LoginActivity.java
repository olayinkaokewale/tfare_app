...
public class LoginActivity extends Activity {
    ...
    private class LoginTask extends AsyncTask<String, String, String> {
        int feedback = 0;
        String errorMessage = "Unable to log in at the moment. Please try again";
        @Override
        ...
        protected String doInBackground(String... strings) {
            try {
                ...
                request.put(Definitions.SERVER_ACTION, Definitions.ACTION_LOGIN);
                ...
                if (result != null) {
                    ...
                    if (feedback == 1) { //Proceed to storing the data into shared preference and database.
                        ...
                        SharedPreferences prefs = LoginActivity.this.getSharedPreferences(Definitions.PREFERENCE_FILE, MODE_PRIVATE);

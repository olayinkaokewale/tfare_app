...
public class TutorialActivity extends Activity {
    ...
    private void launchHomeScreen() {
        ...
        if (isFirstTime) {
            ...
            editor.putBoolean(Definitions.ISFIRSTTIME, false);
            editor.commit();
        }
        Intent mainActivity = new Intent(TutorialActivity.this, MainActivity.class);
        if (!isRegistered) {
            mainActivity = new Intent(TutorialActivity.this, RegisterActivity.class);
        }
    ...
    ViewPager.OnPageChangeListener viewPagerPageChangeListener = new ViewPager.OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            if (position == layouts.length - 1) {
                ...
                btnNext.setText(getString(R.string.tut_start));
                btnSkip.setVisibility(View.GONE);
            } else {
                // still pages are left
                btnNext.setText(getString(R.string.tut_next));
